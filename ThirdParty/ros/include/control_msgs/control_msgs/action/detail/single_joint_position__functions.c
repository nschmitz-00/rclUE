  ...
  control_msgs__action__SingleJointPosition_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_Goal * data =
      (control_msgs__action__SingleJointPosition_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  control_msgs__action__SingleJointPosition_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_Result * data =
      (control_msgs__action__SingleJointPosition_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  control_msgs__action__SingleJointPosition_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_Feedback * data =
      (control_msgs__action__SingleJointPosition_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  control_msgs__action__SingleJointPosition_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_SendGoal_Request * data =
      (control_msgs__action__SingleJointPosition_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  control_msgs__action__SingleJointPosition_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_SendGoal_Response * data =
      (control_msgs__action__SingleJointPosition_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
control_msgs__action__SingleJointPosition_SendGoal_Event__init(control_msgs__action__SingleJointPosition_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    control_msgs__action__SingleJointPosition_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!control_msgs__action__SingleJointPosition_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    control_msgs__action__SingleJointPosition_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    control_msgs__action__SingleJointPosition_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
control_msgs__action__SingleJointPosition_SendGoal_Event__fini(control_msgs__action__SingleJointPosition_SendGoal_Event * msg)
{
  ...
  // request
  control_msgs__action__SingleJointPosition_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  control_msgs__action__SingleJointPosition_SendGoal_Response__Sequence__fini(&msg->response);
}
...
control_msgs__action__SingleJointPosition_SendGoal_Event__are_equal(const control_msgs__action__SingleJointPosition_SendGoal_Event * lhs, const control_msgs__action__SingleJointPosition_SendGoal_Event * rhs)
{
  ...
  // request
  if (!control_msgs__action__SingleJointPosition_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_SendGoal_Response__Sequence__are_equal(
  ...
  control_msgs__action__SingleJointPosition_SendGoal_Event * output)
{
  ...
  // request
  if (!control_msgs__action__SingleJointPosition_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_SendGoal_Event * msg = (control_msgs__action__SingleJointPosition_SendGoal_Event *)allocator.allocate(sizeof(control_msgs__action__SingleJointPosition_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(control_msgs__action__SingleJointPosition_SendGoal_Event));
  bool success = control_msgs__action__SingleJointPosition_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__init(control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_SendGoal_Event * data = NULL;

  if (size) {
    data = (control_msgs__action__SingleJointPosition_SendGoal_Event *)allocator.zero_allocate(size, sizeof(control_msgs__action__SingleJointPosition_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = control_msgs__action__SingleJointPosition_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        control_msgs__action__SingleJointPosition_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__fini(control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      control_msgs__action__SingleJointPosition_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * array = (control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence *)allocator.allocate(sizeof(control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__destroy(control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence__are_equal(const control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * lhs, const control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!control_msgs__action__SingleJointPosition_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  control_msgs__action__SingleJointPosition_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(control_msgs__action__SingleJointPosition_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    control_msgs__action__SingleJointPosition_SendGoal_Event * data =
      (control_msgs__action__SingleJointPosition_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!control_msgs__action__SingleJointPosition_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
  ...
  control_msgs__action__SingleJointPosition_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_GetResult_Request * data =
      (control_msgs__action__SingleJointPosition_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  control_msgs__action__SingleJointPosition_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_GetResult_Response * data =
      (control_msgs__action__SingleJointPosition_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
control_msgs__action__SingleJointPosition_GetResult_Event__init(control_msgs__action__SingleJointPosition_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    control_msgs__action__SingleJointPosition_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!control_msgs__action__SingleJointPosition_GetResult_Request__Sequence__init(&msg->request, 0)) {
    control_msgs__action__SingleJointPosition_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_GetResult_Response__Sequence__init(&msg->response, 0)) {
    control_msgs__action__SingleJointPosition_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
control_msgs__action__SingleJointPosition_GetResult_Event__fini(control_msgs__action__SingleJointPosition_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  control_msgs__action__SingleJointPosition_GetResult_Request__Sequence__fini(&msg->request);
  // response
  control_msgs__action__SingleJointPosition_GetResult_Response__Sequence__fini(&msg->response);
}
...
control_msgs__action__SingleJointPosition_GetResult_Event__are_equal(const control_msgs__action__SingleJointPosition_GetResult_Event * lhs, const control_msgs__action__SingleJointPosition_GetResult_Event * rhs)
{
  ...
  // request
  if (!control_msgs__action__SingleJointPosition_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  control_msgs__action__SingleJointPosition_GetResult_Event * output)
{
  ...
  // request
  if (!control_msgs__action__SingleJointPosition_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!control_msgs__action__SingleJointPosition_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_GetResult_Event * msg = (control_msgs__action__SingleJointPosition_GetResult_Event *)allocator.allocate(sizeof(control_msgs__action__SingleJointPosition_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(control_msgs__action__SingleJointPosition_GetResult_Event));
  bool success = control_msgs__action__SingleJointPosition_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__init(control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_GetResult_Event * data = NULL;

  if (size) {
    data = (control_msgs__action__SingleJointPosition_GetResult_Event *)allocator.zero_allocate(size, sizeof(control_msgs__action__SingleJointPosition_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = control_msgs__action__SingleJointPosition_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        control_msgs__action__SingleJointPosition_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__fini(control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      control_msgs__action__SingleJointPosition_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * array = (control_msgs__action__SingleJointPosition_GetResult_Event__Sequence *)allocator.allocate(sizeof(control_msgs__action__SingleJointPosition_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__destroy(control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
control_msgs__action__SingleJointPosition_GetResult_Event__Sequence__are_equal(const control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * lhs, const control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!control_msgs__action__SingleJointPosition_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  control_msgs__action__SingleJointPosition_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(control_msgs__action__SingleJointPosition_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    control_msgs__action__SingleJointPosition_GetResult_Event * data =
      (control_msgs__action__SingleJointPosition_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!control_msgs__action__SingleJointPosition_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
  ...
  control_msgs__action__SingleJointPosition_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__SingleJointPosition_FeedbackMessage * data =
      (control_msgs__action__SingleJointPosition_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__SingleJointPosition_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          control_msgs__action__SingleJointPosition_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
