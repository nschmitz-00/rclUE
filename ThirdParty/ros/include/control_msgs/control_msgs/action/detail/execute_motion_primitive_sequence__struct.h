...
enum
{
  control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event__request__MAX_SIZE = 1
};
// response
enum
{
  control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ExecuteMotionPrimitiveSequence in the package control_msgs.
typedef struct control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event
{
  service_msgs__msg__ServiceEventInfo info;
  control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Request__Sequence request;
  control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Response__Sequence response;
} control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event;

// Struct for a sequence of control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event.
typedef struct control_msgs__action__ExecuteMotionPrimitiveSequence_SendGoal_Event__Sequence
{
...
enum
{
  control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event__request__MAX_SIZE = 1
};
// response
enum
{
  control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event__response__MAX_SIZE = 1
};

/// Struct defined in action/ExecuteMotionPrimitiveSequence in the package control_msgs.
typedef struct control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event
{
  service_msgs__msg__ServiceEventInfo info;
  control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Request__Sequence request;
  control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Response__Sequence response;
} control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event;

// Struct for a sequence of control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event.
typedef struct control_msgs__action__ExecuteMotionPrimitiveSequence_GetResult_Event__Sequence
{
