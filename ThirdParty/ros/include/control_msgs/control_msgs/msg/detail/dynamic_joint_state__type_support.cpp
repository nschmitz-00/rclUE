...
void fetch_function__DynamicJointState__joint_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__DynamicJointState__joint_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__DynamicJointState__joint_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__DynamicJointState__joint_names(untyped_member, index));
...
void fetch_function__DynamicJointState__interface_values(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const control_msgs::msg::InterfaceValue *>(
    get_const_function__DynamicJointState__interface_values(untyped_member, index));
  auto & value = *reinterpret_cast<control_msgs::msg::InterfaceValue *>(untyped_value);
  value = item;
}

void assign_function__DynamicJointState__interface_values(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<control_msgs::msg::InterfaceValue *>(
    get_function__DynamicJointState__interface_values(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DynamicJointState_message_member_array[3] = {
  ...
  },
  {
    ...
    fetch_function__DynamicJointState__joint_names,  // fetch(index, &value) function pointer
    assign_function__DynamicJointState__joint_names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__DynamicJointState__interface_values,  // fetch(index, &value) function pointer
    assign_function__DynamicJointState__interface_values,  // assign(index, value) function pointer
