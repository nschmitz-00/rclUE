...
{
  new (message_memory) control_msgs::msg::GripperCommand(_init);
}

void GripperCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<control_msgs::msg::GripperCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GripperCommand_message_member_array[2] = {
  {
    ...
    offsetof(control_msgs::msg::GripperCommand, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::GripperCommand, max_effort),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GripperCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(control_msgs::msg::GripperCommand),
...
{
  return &::control_msgs::msg::rosidl_typesupport_introspection_cpp::GripperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, control_msgs, msg, GripperCommand)() {
  return &::control_msgs::msg::rosidl_typesupport_introspection_cpp::GripperCommand_message_type_support_handle;
}
