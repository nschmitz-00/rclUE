...
void fetch_function__JointJog__joint_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__JointJog__joint_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__JointJog__joint_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__JointJog__joint_names(untyped_member, index));
...
void fetch_function__JointJog__displacements(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__JointJog__displacements(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__JointJog__displacements(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__JointJog__displacements(untyped_member, index));
...
void fetch_function__JointJog__velocities(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__JointJog__velocities(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__JointJog__velocities(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__JointJog__velocities(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointJog_message_member_array[5] = {
  ...
  },
  {
    ...
    fetch_function__JointJog__joint_names,  // fetch(index, &value) function pointer
    assign_function__JointJog__joint_names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointJog__displacements,  // fetch(index, &value) function pointer
    assign_function__JointJog__displacements,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__JointJog__velocities,  // fetch(index, &value) function pointer
    assign_function__JointJog__velocities,  // assign(index, value) function pointer
