...
void fetch_function__InterfaceValue__interface_names(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const std::string *>(
    get_const_function__InterfaceValue__interface_names(untyped_member, index));
  auto & value = *reinterpret_cast<std::string *>(untyped_value);
  value = item;
}

void assign_function__InterfaceValue__interface_names(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<std::string *>(
    get_function__InterfaceValue__interface_names(untyped_member, index));
...
void fetch_function__InterfaceValue__values(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__InterfaceValue__values(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__InterfaceValue__values(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__InterfaceValue__values(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember InterfaceValue_message_member_array[2] = {
  {
    ...
    fetch_function__InterfaceValue__interface_names,  // fetch(index, &value) function pointer
    assign_function__InterfaceValue__interface_names,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__InterfaceValue__values,  // fetch(index, &value) function pointer
    assign_function__InterfaceValue__values,  // assign(index, value) function pointer
