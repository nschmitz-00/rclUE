...
static const ::rosidl_typesupport_introspection_cpp::MessageMember JointTrajectoryControllerState_message_member_array[12] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(control_msgs::msg::JointTrajectoryControllerState, speed_scaling_factor),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
