...
#ifndef CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__TRAITS_HPP_
#define CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__TRAITS_HPP_
...
inline void to_yaml(
  const clf_audio_msgs::msg::AudioInfo & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const clf_audio_msgs::msg::AudioInfo & msg)
{
  return clf_audio_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<clf_audio_msgs::msg::AudioInfo>()
{
  return "clf_audio_msgs::msg::AudioInfo";
}

template<>
inline const char * name<clf_audio_msgs::msg::AudioInfo>()
{
  return "clf_audio_msgs/msg/AudioInfo";
}

template<>
struct has_fixed_size<clf_audio_msgs::msg::AudioInfo>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<clf_audio_msgs::msg::AudioInfo>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<clf_audio_msgs::msg::AudioInfo>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__TRAITS_HPP_
