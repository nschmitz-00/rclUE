...
#ifndef CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__STRUCT_HPP_
#define CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__clf_audio_msgs__msg__AudioInfo __attribute__((deprecated))
#else
# define DEPRECATED__clf_audio_msgs__msg__AudioInfo __declspec(deprecated)
#endif
...
struct AudioInfo_
{
  ...
  using ConstRawPtr =
    const clf_audio_msgs::msg::AudioInfo_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      clf_audio_msgs::msg::AudioInfo_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__clf_audio_msgs__msg__AudioInfo
    std::shared_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__clf_audio_msgs__msg__AudioInfo
    std::shared_ptr<clf_audio_msgs::msg::AudioInfo_<ContainerAllocator> const>
...
using AudioInfo =
  clf_audio_msgs::msg::AudioInfo_<std::allocator<void>>;
...
#endif  // CLF_AUDIO_MSGS__MSG__DETAIL__AUDIO_INFO__STRUCT_HPP_
