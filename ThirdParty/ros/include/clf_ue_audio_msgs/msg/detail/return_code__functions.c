...
clf_ue_audio_msgs__msg__ReturnCode__create(void)
{
  ...
  clf_ue_audio_msgs__msg__ReturnCode * msg = (clf_ue_audio_msgs__msg__ReturnCode *)allocator.allocate(sizeof(clf_ue_audio_msgs__msg__ReturnCode), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(clf_ue_audio_msgs__msg__ReturnCode));
  bool success = clf_ue_audio_msgs__msg__ReturnCode__init(msg);
  if (!success) {
...
clf_ue_audio_msgs__msg__ReturnCode__destroy(clf_ue_audio_msgs__msg__ReturnCode * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    clf_ue_audio_msgs__msg__ReturnCode__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
clf_ue_audio_msgs__msg__ReturnCode__Sequence__init(clf_ue_audio_msgs__msg__ReturnCode__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  clf_ue_audio_msgs__msg__ReturnCode * data = NULL;

  if (size) {
    data = (clf_ue_audio_msgs__msg__ReturnCode *)allocator.zero_allocate(size, sizeof(clf_ue_audio_msgs__msg__ReturnCode), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = clf_ue_audio_msgs__msg__ReturnCode__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        clf_ue_audio_msgs__msg__ReturnCode__fini(&data[i - 1]);
      }
...
clf_ue_audio_msgs__msg__ReturnCode__Sequence__fini(clf_ue_audio_msgs__msg__ReturnCode__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      clf_ue_audio_msgs__msg__ReturnCode__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  clf_ue_audio_msgs__msg__ReturnCode__Sequence * array = (clf_ue_audio_msgs__msg__ReturnCode__Sequence *)allocator.allocate(sizeof(clf_ue_audio_msgs__msg__ReturnCode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = clf_ue_audio_msgs__msg__ReturnCode__Sequence__init(array, size);
  if (!success) {
...
clf_ue_audio_msgs__msg__ReturnCode__Sequence__destroy(clf_ue_audio_msgs__msg__ReturnCode__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    clf_ue_audio_msgs__msg__ReturnCode__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
clf_ue_audio_msgs__msg__ReturnCode__Sequence__are_equal(const clf_ue_audio_msgs__msg__ReturnCode__Sequence * lhs, const clf_ue_audio_msgs__msg__ReturnCode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!clf_ue_audio_msgs__msg__ReturnCode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  clf_ue_audio_msgs__msg__ReturnCode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(clf_ue_audio_msgs__msg__ReturnCode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    clf_ue_audio_msgs__msg__ReturnCode * data =
      (clf_ue_audio_msgs__msg__ReturnCode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!clf_ue_audio_msgs__msg__ReturnCode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          clf_ue_audio_msgs__msg__ReturnCode__fini(&output->data[i]);
        }
        return false;
      }
    }
